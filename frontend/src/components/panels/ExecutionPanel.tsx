    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-1 mb-2">
        <div className="p-1.5 rounded border bg-card/50">
          <div className="text-3xs text-muted-foreground">Balance</div>
          <div className="text-sm font-bold font-mono">${execution.balance.toLocaleString()}</div>
        </div>
        <div className="p-1.5 rounded border bg-card/50">
          <div className="text-3xs text-muted-foreground">Equity</div>
      ...
      <div className="space-y-1.5 mb-2">
        <div className="flex items-center justify-between">
          <span className="text-3xs text-muted-foreground">Size (lots)</span>
        ...
        <div className="flex items-center justify-between">
          <span className="text-3xs text-muted-foreground">Stop Loss</span>
          <Input
            value={stopLoss}
        ...
        <div className="flex items-center justify-between">
          <span className="text-3xs text-muted-foreground">Take Profit</span>
          <Input
            value={takeProfit}
      ...
      <div className="grid grid-cols-3 gap-1 mb-2">
        <div className="p-1 rounded border bg-card/50 text-center">
          <div className="text-3xs text-muted-foreground">Risk</div>
          <div className="text-xs font-bold font-mono text-destructive">${risk.toFixed(0)}</div>
        </div>
        <div className="p-1 rounded border bg-card/50 text-center">
          <div className="text-3xs text-muted-foreground">Reward</div>
          <div className="text-xs font-bold font-mono text-success">${reward.toFixed(0)}</div>
        </div>
        <div className="p-1 rounded border bg-card/50 text-center">
          <div className="text-3xs text-muted-foreground">R:R</div>
      ...
      {execution.openPositions.length > 0 && (
        <div>
          <h4 className="text-3xs font-semibold text-muted-foreground mb-1">Open Positions</h4>
          {execution.openPositions.map((pos) => (
            <div key={pos.id} className="flex items-center justify-between px-2 py-1 rounded bg-card/50 mb-0.5">
              <div className="flex items-center gap-1">
                ...
                <span className="text-3xs text-muted-foreground">{pos.volume} lots</span>
              </div>
      ...
      {/* Journal button */}
      <Button variant="outline" size="sm" className="w-full h-7 text-2xs mt-2">

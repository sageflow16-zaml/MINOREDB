  ...
  if (isLoading) {
    return (
      <Card className={cn('overflow-hidden', className)}>
        <CardHeader className="py-3 px-4"><CardTitle className="text-xs font-medium flex items-center gap-2"><Sun className="h-4 w-4 text-primary" />Daily Brief</CardTitle></CardHeader>
      ...
      <CardContent className="px-4 pb-4 space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          {brief.currentWeaknesses.length > 0 && (
            <div className="rounded-lg bg-danger/5 border border-danger/10 p-2">
              <p className="text-3xs font-medium text-danger mb-0.5 flex items-center gap-1">
        ...
        <div className="rounded-lg bg-primary/5 border border-primary/10 p-2.5">
          <div className="flex items-center gap-1.5 mb-1">
            ...
            <span className="text-2xs font-medium text-primary">Next Task</span>
          </div>

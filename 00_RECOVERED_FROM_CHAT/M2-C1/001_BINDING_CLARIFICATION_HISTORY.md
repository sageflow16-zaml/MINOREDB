...
## 001 — Faithful measurement specification clarification

| Provenance field | Value |
|---|---|
| Artifact ID | M2-C1-001 |
| Authority / Decision ID | M2-C1 |
| Artifact Type | Faithful measurement specification clarification |
